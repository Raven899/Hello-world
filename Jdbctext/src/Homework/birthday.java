...
public class birthday extends JButton {  
    ...
    public birthday(SimpleDateFormat df, String dateString) {  
        this();  
    ...
    public birthday(String preLabel, Date date) {  
        if (preLabel != null) {  
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {  
        ...
        void showDateChooser(Point position) {  
            Frame owner = (Frame) SwingUtilities.getWindowAncestor(birthday.this);  
    ...
    public static void main(String[] args) {  
        ...
        mainFrame.add(new birthday(), java.awt.BorderLayout.CENTER);  
